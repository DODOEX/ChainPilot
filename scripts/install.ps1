...
$BinName = "chainpilot"
$InstallDir = Join-Path $HOME ".chainpilot\bin"
$TempDir = Join-Path ([System.IO.Path]::GetTempPath()) ("chainpilot-install-" + [System.Guid]::NewGuid().ToString("N"))
